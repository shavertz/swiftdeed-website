              ...
              <div style={s.panelSection}>
                ...
                {loanPayments.length === 0 ? (
                  ...
                  <>
                    ...
                    <div style={{ maxHeight: 136, overflowY: 'auto', overflowX: 'hidden' }}>
                      {loanPayments.map((p, i) => (
                        <div key={p.id || i} style={{ display: 'grid', gridTemplateColumns: '1fr 80px 50px', gap: 4, padding: '6px 0', borderBottom: '0.5px solid #1a1a1a', alignItems: 'center' }}>
